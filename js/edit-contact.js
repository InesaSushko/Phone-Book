class EditContact {
  ...
  main() {
    ...
    return `<main class="main">
      ...
      <div class="edit-foto">
      <img src="images/user-face-mini.png" alt="#" class=" user-img img-circle center-block"></div>
      <div class="main-info-holder"><div class="edit-field">
      <span class="add-btn"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
      <span contenteditable = "true">${this.state.locals.firstName}</span></span></div>
      <div class="edit-field"><span class="add-btn"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
      <span contenteditable = "true">${this.state.locals.lastName}</span></span></div>
      <div class="edit-field"><span class="add-btn"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
      <span contenteditable = "true">${this.state.locals.number}</span></span></div></div></div>
      ...
      <div class="edit-field"><button href="#" class="delete-contact">delete contact</button></div></div></div></form></div></main>`;
  }
