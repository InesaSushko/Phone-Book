class EditContact {
  ...
  createField(param) {
    return param.reduce( (innerHTML, e) => {
      return innerHTML += `<div class="edit-field" >
          ...
          <input type = "text" placeholder="${e}"></input>
				</span>
			</div>`;
    }, ``);
  }
  ...
  main() {
    const editInfo = ["add  home phone","add email","add address","add birthday","add social profile","add field"];
            ...
            <div class="main-info-holder">
              <div class="edit-field">
						    <span class="add-btn"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
							    <span contenteditable = "true">${this.state.locals.firstName}</span>
						    </span>
					    </div>
				    	<div class="edit-field">
						    <span class="add-btn"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
							    <span contenteditable = "true">${this.state.locals.lastName}</span>
						    </span>
					    </div>
					    <div class="edit-field">
						    <span class="add-btn"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>
							    <span contenteditable = "true">${this.state.locals.number}</span>
						    </span>
		    			</div>
            </div>
          </div>
